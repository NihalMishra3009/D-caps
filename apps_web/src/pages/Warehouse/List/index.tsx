...
import { Button, Header, Pagination, SegmentedControl, SpaceBetween, Table } from '@cloudscape-design/components'
            ...
            <Header
              ...
              actions={
                <SpaceBetween direction='horizontal' size='xs'>
                  ...
                  <Button variant='primary' onClick={() => navigate(`/${appvars.URL.WAREHOUSE}/new`)}>
                    New Warehouse
                  </Button>
                </SpaceBetween>
              }
